...
import com.models.ListCustomer;

public class CustomerManagementActivity extends AppCompatActivity {

    ListView lvCustomer;
    ArrayAdapter<Customer> adapter; //để kết nối dữ liệu và ListView
    ...
    private void addEvents() {
        //nhấn vào customer nào thì mở chi tiết nó lên
    ...
    private void addViews() {
        ...
        //Tiến hành truy vấn SQLite Database
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
            Toast.makeText(CustomerManagementActivity.this, "Gửi tin quảng cáo tới hàng loạt khách hàng", Toast.LENGTH_LONG).show();
        }
    ...
    private void process_save_customer(Customer c) {
        ...
        //còn nếu muốn cập nhật thì viết code cập nhật
        /*lc.addCustomer(c);
        adapter.clear();
        adapter.addAll(lc.getCustomers());
    }*/
